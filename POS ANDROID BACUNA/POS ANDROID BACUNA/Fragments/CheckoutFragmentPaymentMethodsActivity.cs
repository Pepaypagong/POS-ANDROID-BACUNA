...
{
    [Activity(Label = "CheckoutFragmentPaymentMethodsActivity", Theme = "@style/AppTheme", ScreenOrientation = Android.Content.PM.ScreenOrientation.Portrait)]
    public class CheckoutFragmentPaymentMethodsActivity : AppCompatActivity
    {
