...
{
    [Activity(Label = "CheckoutFragmentPaymentDoneActivity", Theme = "@style/AppTheme", ScreenOrientation = Android.Content.PM.ScreenOrientation.Portrait)]
    public class CheckoutFragmentPaymentDoneActivity : AppCompatActivity
    {
