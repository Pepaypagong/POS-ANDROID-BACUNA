...
{
    [Activity(Label = "CheckoutFragmentCartAddNoteActivity", Theme = "@style/AppTheme", ScreenOrientation = Android.Content.PM.ScreenOrientation.Portrait)]
    public class CheckoutFragmentCartAddNoteActivity : AppCompatActivity
    {
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            ...
            SetContentView(Resource.Layout.checkout_fragment_cart_add_note);
            ...
            Window.DecorView.Post(() =>
            {
                ...
                keyboardState("VISIBLE", mEtNote);
                mEtNote.RequestFocus();
                mEtNote.SetSelection(mEtNote.Length());
            });
        }
        ...
        private void FnGetData()
        {
            ...
            mEtNote.Text = isBlank ? "" : selectedDescription;
        }
        ...
        private void MBtnSave_Click(object sender, EventArgs e)
        {
            ...
            result.PutExtra("productDescription", mEtNote.Text);
        ...
        private void FnSetControls()
        {
            ...
            mEtNote = FindViewById<EditText>(Resource.Id.etDescription);
            ...
            mEtNote.Hint = "Enter a note here";
        }
